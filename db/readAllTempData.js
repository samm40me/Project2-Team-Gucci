...
async function readAllTempData() {
  try {
    ...
    const cursor = temperatures.find(query, options);
...
readAllTempData().catch(console.dir);

module.exports = { readAllTempData };
